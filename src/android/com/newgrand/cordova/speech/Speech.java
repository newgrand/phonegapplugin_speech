...
public class Speech extends CordovaPlugin implements AudioStatus {
	...
	public void recordStatus(int status, String speexFileUrl) {
		...
		if(speexFileUrl!=null){
	        this.webView.sendJavascript("cordova.require('com.newgrand.cordova.speech.Speech').onRecordStatus("+status+",'" + speexFileUrl + "');");
		}else{
	        this.webView.sendJavascript("cordova.require('com.newgrand.cordova.speech.Speech').onRecordStatus("+status+");");
		}
	}
	...
	public void playStatus(int status, String param) {
		// TODO Auto-generated method stub
        this.webView.sendJavascript("cordova.require('com.newgrand.cordova.speech.Speech').onPlayStatus("+status+",'" + param + "');");
	}
}
